...
### v0.4.0_alpha
发布日期：2026年2月23日
1. 新增：使用 Jetpack Compose 和 Material 3 全面重写
2. 新增：Android 12+ 动态取色（Material You）支持
3. 新增：地址栏可展开菜单（后退、前进、主页、设置）
4. 新增：标签页下拉菜单管理
5. 优化：简化地址栏布局
6. 优化：重新设计开放源代码对话框，显示 MIT 许可证信息
7. 优化：全面屏适配（Edge-to-Edge）
8. 移除：启动页品牌图片
